...
object MessageKeyConstants {
  ...
  val MESSAGE_GAME_STREAM_WON_EVENT = "GAME_STREAM_WON_EVENT"
  val MESSAGE_GAME_STREAM_TIED_EVENT = "GAME_STREAM_TIED_EVENT"
  val MESSAGE_GAME_STREAM_TURN_EVENT = "GAME_STREAM_TURN_EVENT"
  val MESSAGE_OPEN_GAME_STREAM_UPDATE_EVENT = "OPEN_GAME_STREAM_UPDATE_EVENT"
  val MESSAGE_CLOSED_GAME_STREAM_UPDATE_EVENT = "CLOSED_GAME_STREAM_UPDATE_EVENT"
