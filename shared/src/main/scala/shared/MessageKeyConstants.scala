...
object MessageKeyConstants {
  ...
  val MESSAGE_GAME_LOST = "GAME_LOST"
  val MESSAGE_GAME_WON = "GAME_WON"
  val MESSAGE_GAME_OVER = "GAME_OVER"
  val MESSAGE_GAME_TIED = "GAME_TIED"
  val MESSAGE_BOARD_WON = "board_won"
  val MESSAGE_KEEPALIVE = "ping"
  val MESSAGE_OK = "OK"
  val MESSAGE_TURN_COMMAND = "TURN_COMMAND"
  val MESSAGE_PLAY_AGAIN_COMMAND = "PLAY_AGAIN_COMMAND"
  val MESSAGE_JOIN_GAME_COMMAND = "JOIN_GAME_COMMAND"
  val MESSAGE_CREATE_GAME_COMMAND = "CREATE_GAME_COMMAND"
  val MESSAGE_NEW_GAME_CREATED_EVENT = "CREATED_GAME_EVENT"
  val MESSAGE_GAME_STARTED_EVENT = "STARTED_GAME_EVENT"
  val MESSAGE_GAME_REGISTRY_EVENT = "GAME_REGISTRY_EVENT"
